...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("The new balance is: " +myBankBalanceEuro + "€");
    ...
    public static void exercise3() {
        ...
        LocalDate myBirthDay = LocalDate.of(1994, 6, 25);
        int currentYear = LocalDate.now().getYear();
        LocalDate thisYearsBirthday = LocalDate.of(currentYear, myBirthDay.getMonth(), myBirthDay.getDayOfMonth());
        System.out.println("This year my birthday is gonna be on " +thisYearsBirthday);
        long daysBetween = ChronoUnit.DAYS.between(today, thisYearsBirthday);
        System.out.println("My birthday is " +daysBetween +" days from today.");
