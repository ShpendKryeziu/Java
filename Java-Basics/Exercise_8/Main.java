...
public class Main {
    ...
    private static void exercise1() {
        ...
        ourNumberInt += 2;
        String ourNewNumber = String.valueOf(ourNumberInt);
        System.out.println(ourNewNumber);
    }
    ...
    private static void exercise4() {
        ...
        int finishInt = startInt * 2;
        String finishString = String.valueOf(finishInt);
        String concatenatedString = finishString + finishString;
        double startDouble = Double.valueOf(concatenatedString);
        double finishDouble = startDouble / 3.5;
        System.out.println(Math.floor(finishDouble));
    }
}