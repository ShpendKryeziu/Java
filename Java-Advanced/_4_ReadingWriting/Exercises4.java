...
public class Exercises4 {
    ...
    private static void exercise2() {
        ...
        try {
            // Your code here
            String readingFile = Files.readString(MY_PATH);
    ...
    private static void exercise3() {
        ...
        try {
            // Your code here
            String readingFile = Files.readString(MY_PATH);
            String[] fileInLines = readingFile.split("\n");
            int linesInFile = fileInLines.length;
            System.out.println("The number of lines is: " + linesInFile);
        } catch (Exception exception) {
            System.err.println("There was an error!");
            exception.printStackTrace();
            System.exit(0);
    ...
    private static void exercise4() {
        ...
        try {
            // Your code here
            String readingFile = Files.readString(MY_PATH);
            String[] fileInWords = readingFile.split(" ");
            int wordsInFile = fileInWords.length;
            System.out.println("The number of words is: " + wordsInFile);
