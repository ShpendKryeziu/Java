...
public class Exercises1 {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(1, 5, 2))) {        // Qui mi dà un errore perché 1 è duplicato, provo ad eliminarlo
    ...
    private static void exercise2() {
        ...
        System.out.println(fruitsSet);      // apple, banana, kiwi, mango, orange
        ...
        System.out.println(fruitsSet);      // apple, banana, grapes, kiwi, mango, orange, pear
    }
    ...
    private static void exercise3() {
        ...
        int min = Integer.MAX_VALUE;        // Credo che qui abbiano invertito MIN e MAX, perché non troverò mai un max più grande di MAX_VALUE
        int max = Integer.MIN_VALUE;        // Quindi li ho invertiti
        ...
        for (Integer item : setA) {
            if (setB.contains(item)) {itemsContainedInBothSets.add(item);}
        }
