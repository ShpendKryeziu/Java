...
public class Exercises2 {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(0, "Primo");
        myFirstMap.put(1, "Secondo");
        myFirstMap.put(2, "Terzo");

        // 1c. Print the map
        for (Map.Entry<Integer,String> entry : myFirstMap.entrySet()) {
            System.out.println("In un array " + entry.getKey() + " è il " + entry.getValue() + " elemento.");
        }

        // 1d. Access an element in the map with .get
        System.out.println("Congratulazioni, sei arrivato " + myFirstMap.get(0) + "!");
