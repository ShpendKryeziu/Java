...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        for (int i = 0; i < studentAges.size(); i++) {
            Student newStudent = new Student(studentNames.get(i), studentAges.get(i));
    ...
    private static void exercise2() {
        ...
        // Once you've added the correct constructors uncomment the code below, there should be no errors!
